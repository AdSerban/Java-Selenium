...
public class FlightPage extends BasePage {
    ...
    //@FindBy(css = "li[class='ui-menu-item'] a") public List<WebElement> listWebElements;
    //public final By LIST_WEB_ELEMENTS = By.cssSelector("li[class='ui-menu-item'] a");
    ...
    //Static dropdown - daca are tag ul de select e by default static dropDown ul
